...
export type CollectionWithTagRow = Database['public']['Views']['collections_with_tags']['Row']
export type CollectionInsert = Database['public']['Tables']['collections']['Insert']
export type CollectionUpdate = Partial<
  Pick<CollectionRow, 'name' | 'description' | 'is_public' | 'cover_image_url' | 'slug'>
>

export type GradeCondition = Database['public']['Tables']['grade_conditions']['Row']
