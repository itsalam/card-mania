  ...
  return useQuery({
    ...
    queryFn: async () => {
      return await invokeFx<typeof payload, TPriceChartingRes>(
        "price-fetch",
        payload,
        { parseOut: PriceChartingResponse, useQueryParams: false },
      );
    },
    staleTime: 60_000 * 5,
    gcTime: 60_000 * 5,
...
export function usePriceChartingDataBatch(params: {
  card?: Partial<TCard>;
  grades: string[];
}) {
