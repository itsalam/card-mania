...
export type UpdateCollectionTag = Database['public']['Tables']['collection_tags']['Update']
export type InsertCollectionTag = Database['public']['Tables']['collection_tags']['Insert']
...
export type CollectionLike = Nullable<
  Database['public']['Functions']['collections_with_membership']['Returns'][number]
> &
  Nullable<CollectionRow>
...
export type CollectionIdArgs = Nullable<{
  collectionId: string
