...
export const isDefaultCollection = (collection: CollectionRow) => {
  return collection.is_wishlist || collection.is_selling || collection.is_vault
}
...
export const getCollectionName = ({
  ...
  if (collectionKey.collectionType) {
    return collectionKey.collectionType[0].toUpperCase() + collectionKey.collectionType.slice(1)
  }
