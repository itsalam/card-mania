...
export type SettingDescriptor<T> = {
   ...
   */
  resolve?: (input: { system?: T; local?: T; remote?: T; defaultValue: T }) => T
...
export type InferSettingValue<R extends SettingsRegistry, K extends keyof R> =
...
export type UseSettingsStore = <Selected>(selector: (s: SettingsStoreState) => Selected) => Selected
