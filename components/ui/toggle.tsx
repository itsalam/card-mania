...
const toggleVariants = tva(
  {
    base: 'web:group web:inline-flex items-center justify-center rounded-md web:ring-offset-background web:transition-colors web:hover:bg-muted active:bg-muted web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2',
    variants: {
      variant: {
...
const toggleTextVariants = tva( {
  base: 'text-sm native:text-base text-foreground font-medium',
  variants: {
    variant: {
      default: '',
