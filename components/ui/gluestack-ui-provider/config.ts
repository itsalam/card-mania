...
export const config = {
  light: vars({
    '--color-primary-0': '138 15 15',
    '--color-primary-50': '151 17 17',
    '--color-primary-100': '170 19 19',
    '--color-primary-200': '184 20 20',
    '--color-primary-300': '197 22 22',
    '--color-primary-400': '216 24 24',
    '--color-primary-500': '230 25 25',
    '--color-primary-600': '231 39 39',
    '--color-primary-700': '233 58 58',
    '--color-primary-800': '235 71 71',
    '--color-primary-900': '221 217 242',
    '--color-primary-950': '238 236 249',
