...
function DropdownMenuLabelText({
  className,
  ...props
}: TextProps) {
  return (
    <Text
      className={cn('text-sm native:text-base font-semibold text-foreground web:cursor-default', className)}
      {...props}
    />
  );
}
...
export {
  ...
  DropdownMenuGroup,
  DropdownMenuItem,
  DropdownMenuLabel, DropdownMenuLabelText, DropdownMenuPortal,
