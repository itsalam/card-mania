...
export const inputStyle = cva('border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',{
  variants: {
    size: {
      "search": 'h-16',
      '2xl': 'h-14',
...
type InputVariantConfiguration = 
  VariantProps<typeof inputStyle>;

export type InputVariantProps = InputVariantConfiguration;
type IInputProps = Omit<TextFieldProps, "variant" | "size"> & InputVariantProps;
