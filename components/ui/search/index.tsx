...
type SearchBarProps = ComponentProps<typeof BaseSearchInput> &
  InputVariantProps & {
    onOptionsPress?: () => void
...
const SearchInput = forwardRef<
  ComponentRef<typeof BaseSearchInput>,
  ComponentProps<typeof BaseSearchInput>
>((props, ref) => {
  const {
    preset = 'default',
    onDismiss,
  ...
  const renderIcon = (icon: ImageSourceType, left = true) => {
  ...
  const renderLoader = () => {
    ...
    return (
      <View>
        {customLoader ? customLoader : <ActivityIndicator style={styles.loader} {...loaderProps} />}
      </View>
    )
  }
